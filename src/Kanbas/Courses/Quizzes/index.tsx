            ...
            <ul id="wd-modules" className="list-group rounded-0">
                <li className="wd-module list-group-item p-0 mb-5 fs-5 border-gray">
                    ...
                    <ul id="wd-assignment-list" className="wd-lessons list-group rounded-0">
                        ...
                        <div className="center-justify p-3">
                            {quizzes.length === 0 ? (
                        ...
                        {quizzes.map((quiz: any) => (
                            <li className="wd-lesson list-group-item p-3 ps-5">
                                ...
                                <br /><span className="red-text">Multiple Modules</span> | <b>Not available until </b> {quiz.available || quiz.available_raw.toString()} |<br />
                                <b>Due</b> {quiz.due || quiz.due_raw.toString()} | {quiz.points} pts


                                <div className="float-end">
                                    <ProtectedAdminRoute>
                                        <FaPencil onClick={() =>
                                            window.location.href = `#/Kanbas/Courses/${quiz.course}/Assignments/${quiz._id}`}
